...
<body>
    <div id="app">
        ...
        @else
                ...
                @if (Route::is('/'))
                    ...
                    <div class="header-carousel owl-carousel">
                        <div class="header-carousel-item">
                            <img src="{{ asset('assets/img/coursel1.jpg') }}" class="img-fluid w-100" alt="Image">
                                    ...
                                    <div class="row g-5">
                                        <div class="col-12 animated fadeInUp">
                                            <div class="text-center">
                                                ...
                                                <h1 class="display-4 text-uppercase text-white mb-4">Full Stack Web
                                                    Apps</h1>
                ...
                @else
                    ...
                    <div class="container-fluid bg-breadcrumb">
                        <div class="container text-center py-5" style="max-width: 900px;">
                            <h4 class="text-white display-4 mb-4 wow fadeInDown text-capitalize"
                                data-wow-delay="0.1s">
                                {{ $title }}</h4>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-3">
                            <div class="footer-item">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <p class="text-white mb-0">Egerton University Njoro</p>
                                </div>
                                <div class="d-flex align-items-center">
            ...
            <!-- Back to Top -->
            <a href="#" class="btn main-bg btn-lg-square rounded-circle back-to-top"><i
