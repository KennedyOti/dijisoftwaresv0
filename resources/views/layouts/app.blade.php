                ...
                <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-flex flex-wrap">
                        ...
                        <a href="tel:+01234567890" class="text-muted small me-4"><i
                                class="fas fa-phone-alt main-color me-2"></i>+01234567890</a>
                        <a href="mailto:example@gmail.com" class="text-muted small me-0"><i
                                class="fas fa-envelope main-color me-2"></i>Example@gmail.com</a>
                    </div>
                </div>
        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                <a href="" class="navbar-brand p-0">
                    <h1 class="main-color"><i class="fas fa-search-dollar me-3"></i>Stocker</h1>
                                ...
                                <div class="row gy-0 gx-5">
                                    ...
                                    <div class="col-xl-7 animated fadeInLeft">
                                        <div class="text-sm-center text-md-end">
                                            <h4 class="main-color text-uppercase fw-bold mb-4">Welcome To Stocker</h4>
